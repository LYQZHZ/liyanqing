...
class get_result(object):
    def __init__(self,host,text,yuanyuzhong,mubiaoyuzhong):
        # 应用ID（到控制台获取）
        self.APPID = "27e70702"
        # 接口APISercet（到控制台机器翻译服务页面获取）
        self.Secret = "MDJhZmNhM2YzMGI1MTQ4ZWRlMDAwODA5"
    ...
    def call_url(self):
        ...
        if self.APPID == '' or self.APIKey == '' or self.Secret == '':
            ...
            if status_code!=200:
                ...
                result2=respData['data']['result']['trans_result']['dst']
...
def fanyi(text,yuanyuzhong,mubiaoyuzhong):
    host = "itrans.xfyun.cn"
    # 初始化类
    gClass = get_result(host,text,yuanyuzhong,mubiaoyuzhong)
    gClass.call_url()
